...
export const metadata = buildMetadata({
  ...
  description:
    "Free FSMA 204 compliance gap assessment. Answer 10 questions and get your facility readiness score in 5 minutes — just enter your email to see your results.",
