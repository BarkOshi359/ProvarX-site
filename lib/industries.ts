...
export const industries: IndustryPage[] = [
  {
    ...
    metaTitle: 'FSMA 204 Compliance Software for Meat Processors | Provarx',
    metaDescription: 'FSMA 204 and FSIS HACCP compliance software for meat and poultry processors. Tamper-proof kill step records, lot traceability, and 24-hour recall trace.',
  ...
  },
  {
    ...
    metaTitle: 'FSMA 204 Compliance Software for Beverage Manufacturers | Provarx',
    metaDescription: 'FSMA 204 compliance software for beverage manufacturers. Digital CIP validation, multi-SKU batch records, allergen changeover documentation, and audit export.',
    relatedTool: 'fsma-gap-assessment',
    relatedPost: 'fsma-204-compliance-guide-food-manufacturers',
  },
  {
    ...
    metaTitle: 'PMO & FSMA 204 Compliance Software for Dairy Plants | Provarx',
    metaDescription: 'PMO and FSMA 204 compliance software for dairy plants. Pasteurization log integrity, CIP cycle records, and dual audit export for FDA and state dairy inspectors.',
  ...
  },
  {
    ...
    metaTitle: '21 CFR Part 111 & FSMA 204 Compliance for Nutraceutical Manufacturers | Provarx',
    metaDescription: '21 CFR Part 111 cGMP compliance software for dietary supplement manufacturers. COA tracking, formula versioning, lot traceability, and FDA warning letter defense.',
    relatedTool: 'fsma-gap-assessment',
  ...
  },
  {
    ...
    metaDescription: 'FSMA 204 and HACCP compliance software for frozen food manufacturers. CCP temperature monitoring, allergen zoning records, and multi-plant lot traceability.',
  ...
  },
  {
    ...
    metaDescription: 'FSMA 204 compliance software for co-packers and contract manufacturers. Client-isolated batch records, SQF/BRC audit export, and multi-brand allergen documentation.',
    relatedTool: 'fsma-gap-assessment',
    relatedPost: 'blockchain-batch-records-tamper-proof-food-manufacturing',
  },
]
